...
-- FIX: Removed static Character references to prevent Nil Error on respawn
function GetChar() 
...
-- Duplicate EquipTool function removed, kept the fixed one at the top
        ...
        if _G.AutoFarm then
            pcall(function()
                    ...
                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        for _,M in pairs(tableMon) do
                            if v.Name == M then
                                ...
                                repeat
                                    wait(_G.Fast_Delay)
                                    if not v or not v.Parent or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Humanoid") or v.Humanoid.Health <= 0 then break end
                ...
                if WorldOrigin and WorldOrigin:FindFirstChild("EnemySpawns") then
                    for i,v in pairs(WorldOrigin.EnemySpawns:GetChildren()) do
                        for _,M in pairs(tableMon) do
                        ...
                        if v.Name == "Core" and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                            repeat
                                ...
                                repeat 
                                    ...
                                    wait()
                                    local HRP = GetHRP()
                                until not _G.Factory or (HRP and (HRP.Position-targetPos.Position).Magnitude <= 10)
...
spawn(function()
    while task.wait() do
        if _G.Auto_Holy_Torch then
           -- Placeholder for Holy Torch logic
        end
    end
end)
    ...
    while task.wait() do
        if _G.AutoLevel then
            pcall(function()
                ...
                local questActive = QuestGui and QuestGui.Visible
                local questText = questActive and QuestGui.Container.QuestTitle.Title.Text or ""
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            if v.Name == Ms then
                                repeat
                                    wait(_G.Fast_Delay)
                                    if not v or not v.Parent or not v:FindFirstChild("HumanoidRootPart") then break end
                                    ...
                                    local currentQ = LocalPlayer.PlayerGui.Main:FindFirstChild("Quest")
                                    local qAct = currentQ and currentQ.Visible
                                until not _G.AutoLevel or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not qAct
                            end
                        end
                    end

                    -- Spawn noktalarına gidip Tween ile farm
                    local WO = game:GetService("Workspace"):FindFirstChild("_WorldOrigin")
                    if WO and WO:FindFirstChild("EnemySpawns") then
                        for i,v in pairs(WO.EnemySpawns:GetChildren()) do
                    ...
                    if v:IsA("Tool") and string.find(v.Name, "Fruit") then
                        ...
                        if handle then
                            ...
                            until not _G.AutoFruitTeleport
                                or (hrp and (hrp.Position - handle.Position).Magnitude <= 8)
                                or not v.Parent
...
-- Options.ToggleFruitNotify:SetValue(false) -- Removed undefined reference
...
-- Options.ToggleAutoFruitTP:SetValue(false) -- Removed undefined reference
...
-- Options.ToggleAutoChest:SetValue(false) -- Removed undefined
        ...
        if _G.AutoChest then
            pcall(function()
                ...
                if chest and chest:FindFirstChild("Part") then
                    ...
                    or (hrp and (hrp.Position - chest.Part.Position).Magnitude <= 6)
                    or not chest.Parent
...
if Third_Sea then
    ...
    -- Options.ToggleSeaBeast:SetValue(false) -- Removed
            ...
            if _G.IslandESP then
                if v.Name ~= "Sea" then
                    if not v:FindFirstChild('NameEsp') then
                        ...
                        name.Text = (v.Name .. " \n" .. round((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Position).Magnitude / 3) .. " M")
